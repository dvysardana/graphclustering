...
class GraphClusterer_Clusterone_CP_Overlapping(object):
    ...
    def clusterone_worker(self):
        self.phase1data = Phase1Data_Clusterone_CP(GraphClusterer_Clusterone_CP_Overlapping.graphdata,
                                     GraphClusterer_Clusterone_CP_Overlapping.configdata)
        self.clusterone_growth_phase()
        self.phase2data = Phase2Data_Clusterone_CP(GraphClusterer_Clusterone_CP_Overlapping.graphdata,
                                     GraphClusterer_Clusterone_CP_Overlapping.configdata,
