...
from GraphData_Clusterone_Gene_pre import GraphData_Clusterone_Gene
...
from Phase2Data_Clusterone_gene_pre import Phase2Data_Clusterone_gene_pre
...
class GraphClusterer_Clusterone_semisupervised(object):
    ...
    def clusterone_worker(self):
        ...
        self.phase2data = Phase2Data_Clusterone_gene_pre(GraphClusterer_Clusterone_semisupervised.graphdata,
                                     GraphClusterer_Clusterone_semisupervised.configdata,
