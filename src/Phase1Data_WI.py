...
class Phase1Data_WI(Phase1Data):
    def __init__(self, graphdata, configdata, K):
        super(Phase1Data_WI, self).__init__(graphdata, configdata, K)
    ...
    def add_node_to_cluster_label(self, node, cluster_label, cluster_center, algorithm_name):
        ...
        if(self.cnodes_dict.get(cluster_label) == None):
            #Create a new cnode
            cnode = CNodeData_WI(cluster_label, -1, -1, cluster_center, self.graphdata, self.configdata)
