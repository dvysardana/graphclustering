...
from Phase2Data_WI_Overlapping import Phase2Data_WI_Overlapping
...
class GraphClusterer_WI_semisupervised(object):
    ...
    def MKNN_worker(self, K):
        self.phase1data = Phase1Data_WI(GraphClusterer_WI_semisupervised.graphdata,
                                     GraphClusterer_WI_semisupervised.configdata,
                                     K)
        self.MKNN_Phase1()
        self.phase2data = Phase2Data_WI_Overlapping(GraphClusterer_WI_semisupervised.graphdata,
                                     GraphClusterer_WI_semisupervised.configdata,
                                     K,
